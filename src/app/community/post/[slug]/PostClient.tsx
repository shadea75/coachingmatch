        ...
        <section className="mt-6">
          ...
          <div className="bg-white rounded-2xl p-5 shadow-sm mb-4 text-center">
            <p className="text-gray-600 mb-3 text-sm">
              <Link href={`/login?redirect=/community/post/${postId}`} className="text-primary-500 font-semibold hover:underline">Accedi</Link>
              {' '}o{' '}
              <Link href="/register" className="text-primary-500 font-semibold hover:underline">registrati</Link>
