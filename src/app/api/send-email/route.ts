      ...
      await resend.emails.send({
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <p style="margin-top: 20px; font-size: 12px; color: #999;">Rispondi a questa email per rispondere direttamente a ${name}.</p>
          </div>
        `
      })
      ...
      await resend.emails.send({
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <p style="margin-top: 24px; font-size: 12px; color: #999;">CoachaMi — P.IVA IT02411430685</p>
          </div>
        `
      })
